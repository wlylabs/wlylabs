...
export const PROJECTS = [
  ...
  {
    name: 'Aldus',
    kind: 'distraction-free Project Gutenberg reader',
    url: 'https://github.com/wlylabs/aldus',
    summary:
      'A calm reader for the Project Gutenberg library: search the full catalog, open a book, and read with nothing else on the page. Reading position is saved to the device by default, and syncs across devices for anyone who signs in.',
    highlights: [
      'Full-text search over a trimmed copy of the official Gutenberg catalog feed, resolved entirely server-side',
      'Three reading themes, adjustable text size, a jump-to-chapter table of contents and a progress bar',
      'localStorage is the source of truth for anonymous use; optional Supabase sync merges by most-recently-updated',
      'Book text and covers are read from the Gutenberg static file cache directly, never scraped from its search pages',
    ],
